...
export class OrganisationServiceService {
  ...
  public editOrganisation(orgId:number, organisation:Organisation): Observable<Organisation>
  {
    return this.http.put<Organisation>(`${this.apiServeUrl}/admin/organisations/${orgId}`,organisation);
  }
